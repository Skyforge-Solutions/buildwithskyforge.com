      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-lg text-gray-700 max-w-2xl mx-auto mb-12">
            We have a dedicated tech team of 40+ professionals, offering expertise in development, design, and cutting-edge solutions to help bring your projects to life.
          </p>
